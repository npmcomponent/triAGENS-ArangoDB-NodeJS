...
var url = require('./url'),
    base64 = require('kaerus-component-base64'),
...
Arango.prototype = {
     ...
     * @param justFireAndForget     boolean, if true fire and forget mode is activated.
     * @returns {Arango}
     */
    "setAsyncMode": function(active, justFireAndForget) {
        if (active === false) {
            delete this.header;
            return this;
        }
        var value = "store";
        if (justFireAndForget === true) {
            value = "true";
        }
        this.header = {key: "x-arango-async", value : value};
        return this;
    },
